...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors.basePackage("tn.esprit.investia")) // basePackage permet de demander à Swagger de ne rien documenter en dehors du package "tn.esprit.investia".
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				.title("Investia")
				.description("\"Investia Swagger configuration\"")
				.version("1.1.0")
				.build();
	}
